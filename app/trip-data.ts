...
export const shops = [
  ...
  },
  {
    ...
    items: "Salmó i bròcoli per al Dia 3; fideus i caldo de pollastre; encisam, tomaca, cogombre, olives i formatge fresc; llet, iogurts, pa, ous, pavo, pasta, arròs, tonyina, dacsa, aigua i complements dels pícnics. Caixa prevista: 70–90 €.", taskId: "compra-aviles",
  },
  {
    ...
    items: "Llom per als entrepans dels adults i el sopar; pa; pernil salat; pavo i anxoves; encisam, tomaca, cogombre, olives i formatge fresc; llet, iogurts, aigua i crackers. Caixa prevista: 35–50 €.", taskId: "compra-prestin",
  },
];
...
export const days: Day[] = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "21:15", title: "Sopar a l’apartament", note: "Adults: pollastre, verdura a la planxa i ensalada. Xiquets: fideus amb caldo de pollastre; preparació final ràpida.", tag: "casa" },
    ],
    ...
    food: "Dinar confirmat al Mesón de Furacu. Sopar: adults, pollastre i verdura; Lluís i Cesc, fideus amb caldo de pollastre.",
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "21:15", title: "Sopar", note: "Salmó a la planxa amb bròcoli i un poc de pa. És la nit triada perquè el dinar ha sigut de pícnic.", tag: "casa" },
    ],
    ...
    food: "Pícnic personalitzat a San Pedro. Sopar de salmó a la planxa amb bròcoli.",
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "18:50", title: "Petjades · només si és segur", note: "Fer-les únicament amb marea i camí favorables; si hi ha dubtes, tornar.", map: maps("Huellas de dinosaurio Tazones"), tag: "opcional" },
      { time: "20:10–20:40", title: "Reposició · Alimerka Avilés", note: "Compra curta per als pícnics i sopars dels Dies 5–7. Agafar els refrigerats al final.", map: maps("Alimerka Calle Cristóbal Colón Avilés"), tag: "30 min" },
      { time: "21:00", title: "Sopar lleuger", note: "Ensalada completa amb encisam, tomaca, cogombre i olives; companatge, pa i iogurt.", tag: "casa" },
    ],
    ...
    food: "Dinar a El Cafetín. Sopar lleuger amb ensalada d’encisam, tomaca, cogombre i olives, pa, companatge i iogurt.",
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "12:45–13:25", title: "Pícnic · Cuevas del Mar", note: "Ensalada de pasta amb tonyina, dacsa, olives, ou i tomaca; lactis, crackers i aigua.", tag: "dinar" },
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "13:10–13:45", title: "Pícnic als Lagos", note: "Adults: entrepà de llom. Lluís: pernil salat. Cesc: pavo + anxova. Afegir olives, lactis, crackers i aigua.", tag: "dinar" },
  ...
  },
  {
    ...
    food: "Dinar previst a El Pigüeña. Sopar d’ensalada completa amb encisam, tomaca, olives i formatge fresc.",
